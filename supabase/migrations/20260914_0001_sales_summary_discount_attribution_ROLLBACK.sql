-- =============================================================================
-- ROLLBACK 20260914_0001 — Revierte la atribución del descuento
-- =============================================================================
--
-- Restaura get_sales_summary_v2 tal como estaba EN VIVO antes de 20260914_0001
-- (= 20260601_0005 + access check con current_user_business_ids() c(bid)):
-- descuento COMPLETO de toda orden con algún pago en el rango. CREATE OR
-- REPLACE: idempotente. Cuerpo byte a byte igual al vivo (md5 df9fad09…), así
-- el guard de 20260914_0001 vuelve a pasar si se re-aplica.
-- =============================================================================
