-- =============================================================================
-- ROLLBACK de 20260911_0001_fix_close_cash_session_role_source
-- =============================================================================
-- Restaura la sobrecarga de 4 args tal como la dejó
-- 20260401_0002_cash_close_ownership_hardening (rol leído de memberships,
-- esperado SIN excluir ventas anuladas).
-- OJO: volver atrás re-introduce el bloqueo de cierre en cambio de turno.
-- =============================================================================
