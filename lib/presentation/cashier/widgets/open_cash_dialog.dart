...
class _OpenCashDialogState extends ConsumerState<OpenCashDialog> {
  ...
  KeyEventResult _handleKeyboard(FocusNode node, KeyEvent event) {
    if (_isSubmitting || event is! KeyDownEvent) {
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: _keyboardFocusNode.hasFocus
                          ...
                          : MangoColors.successGreen.withValues(alpha: 0.2),
                      width: 2,
                    ),
                  ),
                  child: Column(
                    children: [
                      ...
                      Text(
                        'Tambien puedes escribir con el teclado',
                        style: TextStyle(
