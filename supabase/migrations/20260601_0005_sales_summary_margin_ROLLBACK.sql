-- =============================================================================
-- ROLLBACK 20260601_0005 — Revierte margen en get_sales_summary_v2
-- =============================================================================
--
-- Restaura la función tal como quedó en 20260531_0002 (cost y gross_profit
-- hardcodeados en 0; sin margin_pct; sin costo en by_category; sin totales de
-- rentabilidad). Es CREATE OR REPLACE: idempotente y seguro.
-- =============================================================================
