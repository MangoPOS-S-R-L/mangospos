-- ROLLBACK de 20260919_0004: vuelve al corte de día por UTC
-- (oi.created_at::date) y quita la franja horaria.
--
-- OJO: restaura el bug del corte a las 8:00 PM locales en RD — medido en el
-- negocio 6d13ed3f, el 93% de la venta de una noche deja de salir en su día.
--
-- Los drops de las firmas de 6 args son OBLIGATORIOS: si quedaran junto a las
-- de 4, PostgREST no resuelve por nombre (PGRST203 ambiguous).
