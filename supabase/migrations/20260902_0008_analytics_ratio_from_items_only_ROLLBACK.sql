-- ROLLBACK de 20260902_0008_analytics_ratio_from_items_only.sql
-- Restaura la vista de 20260830_0009, la que prefería order_item_tax_lines para
-- sacar la proporción ITBIS/LEY.
--
-- OJO: volver atrás REINTRODUCE el hallazgo H-2 — el feed vuelve a reportar Ley
-- 10% en facturas donde ningún producto la lleva.
