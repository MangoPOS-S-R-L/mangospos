...
begin
  ...
  if v_src like '%fn_resolve_area_warehouse%' then
    raise notice 'Guardia de rama: consume_inventory_from_order NO se reemplazó. La viva ya reparte entre varias bodegas (20260901_0006) o es la unificada, y esta versión lo borraría. Aplicar 20260915_0002.';
    return;
  end if;
