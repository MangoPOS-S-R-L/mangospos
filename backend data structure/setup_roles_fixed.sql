-- ========================================================
-- MANGOPOS - SISTEMA COMPLETO DE ROLES Y PERMISOS (FIXED)
-- Versión corregida con orden de creación apropiado
-- ========================================================
-- INSTRUCCIONES:
-- 1. Este script ya tiene el business_id configurado
-- 2. Ejecuta este archivo completo en Supabase SQL Editor
-- ========================================================

-- ========================================================
-- PASO 0: LIMPIAR VISTAS Y OBJETOS EXISTENTES
-- ========================================================

-- Eliminar vistas que puedan causar conflictos
...
-- ========================================================
-- PASO 3: CREAR VISTA Y FUNCIÓN (DESPUÉS DE LAS TABLAS)
-- ========================================================

-- 3.1 VISTA DE RESUMEN DE EMPLEADOS
...
-- 3.2 FUNCIÓN PARA OBTENER PERMISOS
...
-- 4.1 ROL: ADMINISTRADOR (todos los permisos)
