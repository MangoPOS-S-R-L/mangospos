-- =============================================================================
-- ROLLBACK de 20260531_0001_sales_summary_by_production_area.sql
--
-- Restaura get_sales_summary_v2 a la definición de 20260529_0001 (sin la
-- clave `sales_by_production_area` ni el JOIN a print_areas en scoped_items).
-- El frontend tolera la ausencia: getProductionAreaRows() cae a [] y el
-- sub-reporte se ve vacío, no rompe.
-- =============================================================================
