...
class _MainShellState extends State<MainShell> {
  ...
  Widget build(BuildContext context) {
    ...
    final rawTopBarHeight = context.hp(context.isDesktop ? 7 : context.isTablet ? 9 : 12);
    final topBarHeight = rawTopBarHeight < 64
        ? 64.0
        : rawTopBarHeight > 96
            ? 96.0
            : rawTopBarHeight;
    final horizontalPadding = context.wp(context.isDesktop ? 1.8 : context.isTablet ? 2.8 : 4.5);
          ...
          Expanded(
            child: Padding(
              padding: EdgeInsets.all(
                context.wp(context.isDesktop ? 1.2 : context.isTablet ? 2.4 : 3.5),
              ),
              child: ClipRRect(
