-- =============================================================================
-- Áreas de producción — Business 528df61f-7136-4591-9e87-ee19f5882037
-- Correr DESPUÉS de scripts/import_products_528df61f.sql
--
-- POR QUÉ HACE FALTA:
...
select
  ...
  (select count(*) from public.menu_items mi join _route r on r.sku = mi.sku
    where mi.business_id = '528df61f-7136-4591-9e87-ee19f5882037'::uuid and r.areas = 'KB') as combos_dos_areas,
  (select count(*) from public.menu_items mi
    where mi.business_id = '528df61f-7136-4591-9e87-ee19f5882037'::uuid
