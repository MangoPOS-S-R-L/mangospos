-- Diagnóstico fiscal seguro (sin asumir nombres de columnas)
-- Úsalo primero para descubrir la estructura real antes de correr queries más específicas.
...
-- ============================================================
-- 2. Columnas de fiscal_documents
-- ============================================================
select
  column_name,
  data_type,
...
-- ============================================================
-- 3. Muestra rápida de fiscal_documents
-- ============================================================
select *
...
-- ============================================================
-- 4. Columnas de business_fiscal_settings
-- ============================================================
select
  column_name,
  data_type,
...
from information_schema.columns
where table_schema = 'public'
  and table_name = 'business_fiscal_settings'
order by ordinal_position;

-- ============================================================
-- 5. Muestra rápida de business_fiscal_settings
-- ============================================================
select *
...
-- ============================================================
-- 6. Buscar columnas candidatas para NCF / secuencia / rango
-- ============================================================
select
  table_name,
  column_name,
...
-- ============================================================
-- 8. Índices / constraints sobre fiscal_documents
-- ============================================================
select
  schemaname,
  tablename,
...
-- ============================================================
-- 10. Si sabes el NCF exacto, reemplázalo aquí
-- ============================================================
-- OJO: solo úsalo después de confirmar cómo se llama la columna real.
-- Ejemplo probable:
-- select * from public.fiscal_documents where ncf_number = 'B0200000013';
