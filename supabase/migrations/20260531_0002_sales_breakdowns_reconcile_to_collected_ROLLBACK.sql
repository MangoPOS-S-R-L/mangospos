-- =============================================================================
-- ROLLBACK de 20260531_0002_sales_breakdowns_reconcile_to_collected.sql
--
-- Restaura get_sales_summary_v2 a la definición de 20260531_0001: los
-- desgloses por categoría y por área vuelven a sumar el bruto del ítem
-- (SUM(adjusted_amount)) en vez del monto cobrado repartido. Esto reintroduce
-- el descuadre de RD$850 entre la card "Ventas" y el "Total mostrado" — solo
-- usar si el reparto proporcional causa un problema inesperado.
-- =============================================================================
